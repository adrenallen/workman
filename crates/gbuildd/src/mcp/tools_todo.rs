//! MCP todo tools backed by [`gbuild_core::TodoService`].
...
use super::{GbuildMcp, failure, now_millis, scoped_project, success};
...
impl GbuildMcp {
    ...
    #[tool(description = "Move a todo to another project while preserving comments and completion")]
