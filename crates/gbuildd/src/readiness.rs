...
use gbuild_core::{Process, ProcessId, ProcessStatus, ProjectId};
...
/// One listener attributed to a gbuild process or one of its descendants.
...
/// Ephemeral service/readiness view for one gbuild process.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct Service {
