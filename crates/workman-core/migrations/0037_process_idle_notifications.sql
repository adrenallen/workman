CREATE TABLE notifications_with_process_idle (
...
INSERT INTO notifications_with_process_idle
SELECT id, type, project_id, process_id, todo_id, comment_id, body, created_at, read_at
FROM notifications;

DROP TABLE notifications;
ALTER TABLE notifications_with_process_idle RENAME TO notifications;
