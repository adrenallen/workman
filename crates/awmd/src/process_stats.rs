...
use awm_core::{Process, ProcessId, ProcessKind, ProcessStatus, ProjectId, Store, StoreError};
...
/// One operating-system process below an awm-managed PTY root.
...
/// Aggregated telemetry for one awm process and its subprocess tree.
#[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
...
mod tests {
    ...
    use awm_core::{NewTodo, Project, ScratchpadService, TodoPriority, TodoService};
    ...
    fn process(id: ProcessId, kind: ProcessKind, status: ProcessStatus) -> Process {
        Process {
            ...
            source: awm_core::ProcessSource::Local,
            trust_hash: None,
            status,
            pid: None,
            exit_code: None,
