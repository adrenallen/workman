...
-> Result<(), Box<dyn Error>> {
    ...
    let prompt = "Use only the MCP server named awm. Call whoami, list_agent_tools, and list_processes. Confirm list_agent_tools has an agent_tools array and list_processes has a processes array. After all three calls succeed, print exactly ROUTING_OK and nothing else. Do not use solo or any other MCP server.";
