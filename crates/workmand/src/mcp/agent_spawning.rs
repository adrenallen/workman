...
use super::{
    IDLE_TIMER_WAIT_GUIDANCE, SCRATCHPAD_HANDOFF_GUIDANCE, WORKTREE_AGENT_GUIDANCE, WorkmanMcp,
...
mod tests {
    ...
    fn preamble_carries_identity_project_and_mcp_hints_without_the_secret() {
        ...
        assert!(preamble.contains(IDLE_TIMER_WAIT_GUIDANCE));
        assert!(preamble.contains("immediately finish your response and end the current turn"));
