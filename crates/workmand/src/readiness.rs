...
use workman_core::{Process, ProcessId, ProcessStatus, ProjectId};
...
/// One listener attributed to a Workman process or one of its descendants.
...
/// Ephemeral service/readiness view for one workman process.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct Service {
