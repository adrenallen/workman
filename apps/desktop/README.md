...
the Rust side discovers or starts `awmd`, authenticates to its loopback WebSocket, and forwards
...
Set `AWM_DAEMON_BIN` to use a specific `awmd`. The desktop prefers a sibling daemon binary
