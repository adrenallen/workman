...
the Rust side discovers or starts `gbuildd`, authenticates to its loopback WebSocket, and forwards
...
Set `GBUILD_DAEMON_BIN` to use a specific `gbuildd`. The desktop prefers a sibling daemon binary
