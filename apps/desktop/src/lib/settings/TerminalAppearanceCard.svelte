...
<section class="terminal-section" aria-labelledby="terminal-appearance-title">
  ...
  <div class="terminal-preview" style={`font-family: ${terminalFontCss($appearance.terminalFont)}; font-size: ${$appearance.terminalFontSize}px`}>
    ...
    <p><span>gbuild</span> › cargo test</p>
    <p class="output">test result: <strong>ok</strong>. 42 passed; 0 failed</p>
    <p><span>gbuild</span> › <i class="cursor"></i></p>
  </div>
...
<style>
  ...
  .geometry { border: 1px solid var(--border); border-radius: 3px; padding: 5px 7px; background: var(--night); color: var(--text-soft); font-size: 8px; }
  ...
  .setting-copy small { margin-top: 3px; color: var(--muted); font-size: 7px; }
  ...
  output { color: var(--text-soft); font-size: 8px; text-align: center; }

  .terminal-preview { min-height: 116px; border-top: 1px solid var(--border); padding: 9px 12px 10px; background: #0e1517; color: #d7e2dc; line-height: 1.42; }
  .terminal-bar { display: flex; align-items: center; gap: 7px; margin: -1px 0 8px; color: #71827e; font: 8px/1 'JetBrains Mono Variable', monospace; text-transform: uppercase; }
  .terminal-bar i { width: 6px; height: 6px; border-radius: 50%; background: var(--signal); }
  .terminal-bar small { margin-left: auto; font-size: 8px; }
