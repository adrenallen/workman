...
<section class="sidebar-card" aria-labelledby="sidebar-settings-title">
  <header>
    ...
    <span class="saved"><i aria-hidden="true"></i>Saved locally</span>
  </header>
...
<style>
  ...
  header p { margin: 4px 0 0; color: var(--muted); font-size: 10px; }
  .saved { display: flex; align-items: center; gap: 6px; border: 1px solid var(--border); border-radius: 3px; padding: 5px 7px; background: var(--night); color: var(--muted); font-size: 7px; }
  .saved i { width: 5px; height: 5px; border-radius: 50%; background: var(--signal); }
  ...
  .rail-row strong { color: var(--text-soft); font-size: 10px; font-weight: 660; }
  .rail-row small { margin-top: 3px; color: var(--muted); font-size: 7px; line-height: 1.35; }
  output { color: var(--text-soft); font-size: 8px; text-align: right; }
  kbd { display: grid; min-height: 23px; place-items: center; border: 1px solid var(--border-strong); border-bottom-color: color-mix(in srgb, var(--text) 30%, var(--border)); border-radius: 3px; background: var(--surface-raised); color: var(--text-soft); font-size: 7px; }
  ...
  .guidance strong { color: var(--text-soft); font-size: 9px; }
  .guidance small { margin-top: 3px; color: var(--muted); font-size: 7px; line-height: 1.4; }
  footer { min-height: 36px; border-top: 1px solid var(--border); padding: 11px 12px; color: var(--muted); font-size: 7px; }
